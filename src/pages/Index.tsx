  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="twitter:title" content="Situ Men Friseursalon | Premium Barbershop Bielefeld" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/situmenfriseur",
              "https://www.instagram.com/situmenfriseur"
            ]
          })}
        </script>
      </Helmet>
